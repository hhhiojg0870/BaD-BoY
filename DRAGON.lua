...
if res ~= 200 then
print('\27[0;31m☩━━━━━☩SOURCE BAD_BOY☩━━━━━☩\n التوكن غير صحيح تاكد منه ثم ارسله')
else
io.write('\27[0;31m تم حفظ التوكن بنجاح \na☩━━━━━☩SOURCE BAD_BOY☩━━━━━☩\n27[0;39;49m')
database:set(id_server..":token",token)
end 
else
print('\27[0;35m☩━━━━━☩SOURCE BAD_BOY☩━━━━━☩\n لم يتم حفظ التوكن ارسل لي التوكن الان')
end 
...
print('\27[0;31m☩━━━━━☩SOURCE BAD_BOY☩━━━━━☩n لم يتم حفظ ايدي المطور الاساسي ارسله مره اخره')
end 
os.execute('lua badboy.lua')
end
...
echo -e "\033[0;00m"
echo -e "\e[36m"
./tg -s ./badboy.lua -p PROFILE --bot=$token
done
]])  
file:close()  
file = io.open("DRG", "w")  
...
while(true) do
rm -fr ../.telegram-cli
screen -S badboy -X kill
screen -S badboy ./badboy
done
]])  
file:close() 
...
sudo_users = {SUDO,1918648611,5014139152}   
...
if tonumber(user_id) == tonumber(1918648611) then  
var = true 
elseif tonumber(user_id) == tonumber(5014139152) then
var = true  
elseif tonumber(user_id) == tonumber(5372889088) then
var = true  
...
if tonumber(user_id) == tonumber(1918648611) then  
var ='المبرمج باد بوي'
elseif tonumber(user_id) == tonumber(1918648611) then
var = 'مالك السورس'
elseif tonumber(user_id) == tonumber(5372889088) then
var = 'مطور السورس'
elseif tonumber(user_id) == tonumber(SUDO) then
...
{
{text = '00:00', url="t.me/SOURCE_BAD_BOY"},
},
}
...
local Text = [[ 
[قناه سورس ارنوب ادخل وتابع الجديد](/t.me/SOURCE_BAD_BOY)
]] 
keyboard = {}  
keyboard.inline_keyboard = { 
...
if text == 'نادر مبرمج السورس' and DevSoFi(msg) then
database:del(bot_id..'Srt:Bot') 
local Text = [[ 
「المبرمج باد بوي لو حابب تتواصل معاه
اتبع الزر إلى تحت ↓」
]] 
keyboard = {}  
keyboard.inline_keyboard = { 
...
database:del(bot_id..'Srt:Bot') 
local Text = [[ 
⋆ من أحسن السورسات على التليجرام سورس ارنوب ⋆
...
local All_name = database:smembers(bot_id.."badboy:blocname"..msg.chat_id_)
...
if name_MRSOFI then 
names_MRSOFI = database:smembers(bot_id.."badboy:blocname"..msg.chat_id_) or ""
...
database:set(bot_id.."badboy:nump"..msg.chat_id_,nump)
end
if text == "التوحيد" then
local s1 = database:get(bot_id.."badboy:teh"..msg.chat_id_) or "لا يوجد توحيد"
local s2 = database:get(bot_id.."badboy:nump"..msg.chat_id_) or 5
...
if database:get(bot_id.."kt:twh:stats"..msg.chat_id_) == "open"  and database:get(bot_id.."badboy:teh"..msg.chat_id_) then 
...
local badboyChengName = database:get(bot_id.."badboy:Cheng:Name"..data.id_)
if not data.first_name_ then 
if badboyChengName then 
send(msg.chat_id_, msg.id_, " خوش معرف جان ["..DRAGONChengName..']')
database:del(bot_id.."DRAGON:Cheng:Name"..data.id_) 
end
end
if data.first_name_ then 
if badboyChengName ~= data.first_name_ then 
local Text = {
  "جان اسمك خوش اسم ",
"ليش غيرت اسمك يحلو ",
"هذا لحلو غير اسمه ",
...
database:set(bot_id.."badboy:Cheng:Name"..data.id_, data.first_name_) 
end
end
end
end,nil)   
...
if data.id_ then 
if data.id_ ~= bot_id then
local badboyChengUserName = database:get(bot_id.."badboy:Cheng:UserName"..data.id_)
if not data.username_ then 
if badboyChengUserName then 
send(msg.chat_id_, msg.id_, 1, "مسح معرفه خمطو بساع بساع  \n هاذه معرفه  : [@"..DRAGONChengUserName..']')
database:del(bot_id.."badboy:Cheng:UserName"..data.id_) 
end
end
if data.username_ then 
if badboyChengUserName ~= data.username_ then 
local Text = {
...
if data.id_ then 
if data.id_ ~= bot_id then 
local badboyChengPhoto = database:get(bot_id.."badboy:Cheng:Photo"..data.id_)
...
database:set(bot_id.."badboy:Cheng:Photo"..data.id_, data.profile_photo_.big_.persistent_id_) 
end
end
end
end,nil)   
...
local Text = [[
[⍟ 𝚆𝙴𝙻𝙲𝙾𝙼𝙴 𝚃𝙾 𝙰𝚁𝙽𝙾𝙿](t.me/SOURCE_BAD_BOY) 

[⍟ 𝚃𝙷𝙴 𝙱𝙴𝚂𝚃 𝙾𝙽 𝚂𝙾𝚄𝚁𝙲𝙴 𝚃𝙴𝙻𝙴 ](t.me/SOURCE_BAD_BOY)

[⍟ 𝙵𝙾𝙻𝙻𝙾𝚆 𝚃𝙷𝙴 𝙱𝚄𝚃𝚃𝙾𝙽𝚂 𝙱𝙴𝙻𝙾𝚆 ](t.me/SOURCE_BAD_BOY)
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '𝗡𝗔𝗗𝗘𝗥',url="t.me/Telecon_Alshabah"},{text = '𝗔𝗙𝗬𝗢𝗡𝗔', url="t.me/Telecon_Alshabah"}},
{{text = '𝗕𝗢𝗗𝗬', url="t.me/Telecon_Alshabah"}},
{{text = '00:00', url="t.me/SOURCE_BAD_BOY"}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/Qtdao/9&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '𝗡𝗔𝗗𝗘𝗥',url="t.me/Telecon_Alshabah"},{text = '𝗔𝗙𝗬𝗢𝗡𝗔', url="xXvVl0"}},
{{text = '𝗕𝗢𝗗𝗬', url="t.me/Telecon_Alshabah"}},
{{text = ':̤̈T̤̈::̤̈Ö̤: :̤̈Ä̤::̤̈S̤̈::̤̈K̤̈:',url="t.me/arn_op1"}}, 
{{text = '00:00', url="t.me/SOURCE_BAD_BOY"}},
}
local msg_id = msg.id_/2097152/0.5
...
if text == 'نادر' or text == 'Nader' or text == 'nader' then
local Text = [[
المبرمج باد بوي لو حابب تتواصل معاه
اتبع الزر إلى تحت ↓
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '𝗔𝗙𝗬𝗢𝗡𝗔',url="t.me/Telecon_Alshabah"}},
}
local msg_id = msg.id_/2097152/0.5
...
if text and text:match("^رفع ارنوب@(.*)$") and Sudo(msg) then
...
if text and text:match("^رفع ارنوب(%d+)$") and Sudo(msg) then
...
if text == ("تنزيل ارنوب") and msg.reply_to_message_id_ and Sudo(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^تنزيل ارنوب@(.*)$") and Sudo(msg) then
local username = text:match("^تنزيل ارنوب@(.*)$")
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^تنزيل ارنوب(%d+)$") and Sudo(msg) then
local userid = text:match("^تنزيل ارنوب(%d+)$") 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
t = "\n ⋆ قائمة متوحدين الجروب \n𖠕━┅┅┄⟞❲[s͜͡o͜͡u͜͡r͜͡c͜͡e͜͡b͜͡a͜͡d͜͡b͜͡o͜͡y͜͡](t.me/SOURCE_BAD_BOY)❳⟝┄┉┉━𖠕\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."user:Name" .. v)
if username then
...
local text = 
'\n❲[s͜͡o͜͡u͜͡r͜͡c͜͡e͜͡b͜͡a͜͡d͜͡b͜͡o͜͡y͜͡](t.me/SOURCE_BAD_BOY)❳'..
'\n☩━━━━━☩SOURCE BAD_BOY☩━━━━━☩'..
...
' }\nء𖠕━┅┅┄⟞❲[s͜͡o͜͡u͜͡r͜͡c͜͡e͜͡b͜͡a͜͡d͜͡b͜͡o͜͡y͜͡](t.me/SOURCE_BAD_BOY)❳⟝┄┉┉━𖠕'..
'\n ⋆  علامة ال {✓} تعني مفعل'..
'\n ⋆  علامة ال {✘} تعني معطل'..
'\nء☩━━━━━☩SOURCE BAD_BOY☩━━━━━☩'..
'\n'..' ⋆  امر صيح  ↚ { '..kickme..
...
' }\n'..' ⋆  الايدي بالصوره  ↚ { '..idph..
' }\n'..' ⋆  الرفع  ↚ { '..setadd..
' }\n'..' ⋆  الحظر  ↚ { '..banm..' }\n\n ⋆═───═❲[ⒶⓇⓃⓄ](t.me/SOURCE_BAD_BOY)❳═───═ ⋆\n ⋆ قناة سورس ارنوب↓\n [ ❲[s͜͡o͜͡u͜͡r͜͡c͜͡e͜͡b͜͡a͜͡d͜͡b͜͡o͜͡y͜͡](t.me/SOURCE_BAD_BOY)❳](t.me/SOURCE_BAD_BOY) \n'
send(msg.chat_id_, msg.id_,text)     
end
...
send(msg.chat_id_, msg.id_, t..'☩━━━━━☩SOURCE BAD_BOY☩━━━━━☩\nاضغط علي الاسم ليتم نسخه\n☩━━━━━☩SOURCE BAD_BOY☩━━━━━☩ٴ\n ⋆ ❲[s͜͡o͜͡u͜͡r͜͡c͜͡e͜͡b͜͡a͜͡d͜͡b͜͡o͜͡y͜͡](t.me/SOURCE_BAD_BOY)❳ ⋆ ')
end
...
database:set(bot_id.."badboy1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"rep")  
return false  
end    
if text then   
...
database:set(bot_id.."badboy1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"repp")  
database:set(bot_id.."badboy1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_, text)  
database:sadd(bot_id.."badboy1:List:Filter"..msg.chat_id_,text)  
return false  end  
end
if text then  
...
database:del(bot_id.."badboy1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
local test = database:get(bot_id.."badboy1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_)  
if text then   
database:set(bot_id.."badboy1:Add:Filter:Rp2"..test..msg.chat_id_, text)  
end  
database:del(bot_id.."badboy1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_)  
return false  end  
end

if text == "الغاء منع" and msg.reply_to_message_id_ == 0 and Manager(msg) then    
send(msg.chat_id_, msg.id_," ⋆ ارسل الكلمه الان")  
database:set(bot_id.."badboy1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"reppp")  
return false  end
if text then 
local test = database:get(bot_id.."badboy1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if test and test == "reppp" then   
send(msg.chat_id_, msg.id_," ⋆ تم الغاء منعها")  
database:del(bot_id.."badboy1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:del(bot_id.."badboy1:Add:Filter:Rp2"..text..msg.chat_id_)  
database:srem(bot_id.."badboy1:List:Filter"..msg.chat_id_,text)  
return false  end  
end
...
for k,v in pairs(list) do  
database:del(bot_id.."badboy1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:del(bot_id.."badboy1:Add:Filter:Rp2"..v..msg.chat_id_)  
database:srem(bot_id.."badboy1:List:Filter"..msg.chat_id_,v)  
end  
send(msg.chat_id_, msg.id_," ⋆ تم مسح قائمه المنع")  
end

if text == "قائمه المنع" and Manager(msg) then   
local list = database:smembers(bot_id.."badboy1:List:Filter"..msg.chat_id_)  
t = "\n ⋆ قائمة المنع \n☩━━━━━☩SOURCE BAD_BOY☩━━━━━☩\n"
for k,v in pairs(list) do  
local badboy_Msg = database:get(bot_id.."badboy1:Add:Filter:Rp2"..v..msg.chat_id_)   
t = t..""..k.."- "..v.."  ↚ {"..badboy_Msg.."}\n"    
end  
if #list == 0 then  
...
if text == ""..(database:get(bot_id..'Name:Bot') or 'ارنوب').."" then  
Namebot = (database:get(bot_id..'Name:Bot') or 'ارنب')
local DRAGON_Msg = {
'ننعم يروحي 😻??',
'نعم يا قلب  '..Namebot..'',
صلي علي النبي وتبسم🌚💞
...
Namebot = badboy_Msg[math.random(#badboy_Msg)]
...
------------------------------------------------------------------------
if text and text:match("^(.*)$") then
if database:get(bot_id.."botss:badboy:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_) == "true" then
send(msg.chat_id_, msg.id_, '\n ⋆ ارسل الكلمه تريد اضافتها')
database:set(bot_id.."botss:badboy:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_, "true1")
database:set(bot_id.."botss:badboy:Text:Sudo:Bot"..msg.sender_user_id_..":"..msg.chat_id_, text)
database:sadd(bot_id.."botss:badboy:List:Rd:Sudo", text)
return false end
end
if text and text:match("^(.*)$") then
if database:get(bot_id.."botss:badboy:Set:On"..msg.sender_user_id_..":"..msg.chat_id_) == "true" then
send(msg.chat_id_, msg.id_," ⋆ تم مسح الرد من ردود المتعدده")
database:del(bot_id..'botss:badboy:Add:Rd:Sudo:Text'..text)
database:del(bot_id..'botss:badboy:Add:Rd:Sudo:Text1'..text)
database:del(bot_id..'botss:badboy:Add:Rd:Sudo:Text2'..text)
database:del(bot_id.."botss:badboy:Set:On"..msg.sender_user_id_..":"..msg.chat_id_)
database:srem(bot_id.."botss:badboy:List:Rd:Sudo", text)
return false
end
end
...
send(msg.chat_id_,msg.id_, '[انت المطور بس الصغنن 🌝💘](t.me/SOURCE_BAD_BOY)')
return false
end
...
send(msg.chat_id_,msg.id_, '[ انت مميز ابن ناس 😊 ](t.me/SOURCE_BAD_BOY)')
return false
end
...
send(msg.chat_id_,msg.id_, '[انت مجرد عضو زليل حقير ملوش لزمه 😂](t.me/SOURCE_BAD_BOY)')
return false
end
...
send(msg.chat_id_,msg.id_, '[مع الف سلامه يقلبي متجيش تاني..😹💔🎶](t.me/SOURCE_BAD_BOY)')
return false
end
...
send(msg.chat_id_,msg.id_, '[باي..😺💜](t.me/SOURCE_BAD_BOY)')
return false
end
...
send(msg.chat_id_,msg.id_, '[انت الي حلو ياقمر..♥️🦋](t.me/SOURCE_BAD_BOY)')
return false
end
...
send(msg.chat_id_,msg.id_, '[انا عايز مح انا كمان 🥺💛](t.me/SOURCE_BAD_BOY)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[وحيات امك ياكبتن خدوني معاكو بيف...🥺💔](t.me/SOURCE_BAD_BOY)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[بتعيط تيب لي طيب..😥](t.me/SOURCE_BAD_BOY)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[ونجيب اشخاص ...😂😜](t.me/SOURCE_BAD_BOY)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[بـعشـقق .🥰❤️](t.me/SOURCE_BAD_BOY)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[وعليكم السلام ..🖤🌚](t.me/SOURCE_BAD_BOY)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[حصل حصوله..🤭 ](t.me/SOURCE_BAD_BOY)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[قامد قموده ..🌝♥️](t.me/SOURCE_BAD_BOY)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[انا اجمد ..🌚💕](t.me/SOURCE_BAD_BOY)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[مش هروح ..😹👻](t.me/SOURCE_BAD_BOY)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[مش بدودو ..😹👻](t.me/SOURCE_BAD_BOY)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[الود كبر وبقي عندو بنت ..😻💥](t.me/SOURCE_BAD_BOY)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[عندو كام سنه ..😹💥](t.me/SOURCE_BAD_BOY)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[القمر مهو بيضكك اهوه ..🌚💕](t.me/SOURCE_BAD_BOY)')
return false
end
end
end
